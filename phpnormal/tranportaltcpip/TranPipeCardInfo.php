...
<TABLE align=center border=1  bordercolor=black>
   ...
   <tr>
	...
	<tr>
		...
		<option value="2020" selected="selected" >2020</option> lect>
		</td></tr>
		<tr>
		...
		<tr>
			<td width="40%">UDF1</td>
			<td><input size="20" type="text" value="User defined value 1" name="udf1"></td>
		</tr>
		<tr>
			<td width="40%">UDF2</td>
			<td><input size="20" type="text" value="User defined value 2" name="udf2"></td>
		</tr>
		<tr>
			<td width="40%">UDF3</td>
			<td><input size="20" type="text" value="User defined value 3" name="udf3"></td>
		</tr>
		<tr>
			<td width="40%">UDF4</td>
			<td><input size="20" type="text" value="User defined value 4" name="udf4"></td>
		</tr>
		<tr>
			<td width="40%">UDF5</td>
			<td>
				<select class="select" name="udf5" >
			<option value="User defined value 5">User defined value 5</option>
