...
class iPay24Pipe {
	...
	function performPaymentInitializationHTTP() {
		...
		try {
			...
			// echo "<pre>"; print_r($cipheredText); die;
			//print_r("encrypted trandata = :\n".$cipheredText);
			$request .= "&trandata=" . $cipheredText;
			$request .= "&errorURL=" . $this->errorURL . "&responseURL=" . $this->responseURL . "&tranportalId=" . $this->id;
			// $request .= "&errorURL=" . $this->errorURL . "&responseURL=" . $this->responseURL . "&tranportalId=Ultimate";
			//print_r("this->id = :\n".$this->id);
			//print_r("xmlData id = :\n".$xmlData ['id']);
			$this->webAddress = "https://ipg.bobgateway.com/IPG/PaymentHTTP.htm?param=paymentInit" . $request;
			//print_r("webAddress = :\n".$this->webAddress);
		} catch ( Exception $e ) {
	...
	function performTransactionHTTP() {
		...
		//	$cipheredTextsss = $this->decryptData( "", $this->key );
			...
			$this->webAddress = "https://ipg.bobgateway.com/IPG/tranPipeHTTP.htm?param=tranInit" . $request;
	...
	function parseResource($key, $resourcePath, $alias) {
		...
		try {
			...
			// echo "<pre>"; print_r($parseResouce); die;
	...
	function performTranPortalTransaction($request, $webAddress) {
		$webAddress = "https://ipg.bobgateway.com/IPG/tranPipe.htm?param=tranInit";
		$tranType = "tran";
	...
	function performVbVTransaction() {
		...
		try {
			...
			$this->webAddress = "https://ipg.bobgateway.com/IPG/VPAS.htm?actionVPAS=VbvVEReqProcessHTTP" . $request;
	...
	function splitData($trandata) {
		...
		foreach ( $data as $value ) {
			...
			//Added for undefined offset error starts
			if ( ! isset($temp[1])) {
			$temp[1] = null;
			}
			//Added for undefined offset error ends
